...
function ShowDisclaimer() {
  var isHideDisclaimer = getCookie("hide20190213001") == "true" ? true : false;
...
function HideDisclaimer(){
  if($('#disclaimerCheckbox').is(':checked')){
      document.cookie = "hide20190213001=true; expires=Fri, 31 Dec 9999 23:59:59 GMT";
  }
  else{
      document.cookie = "hide20190213001=false; expires=Fri, 31 Dec 9999 23:59:59 GMT";
  }
}
...
function UpdateChanges() {
  ...
  var validateFields = [
    ...
    "input[name='skilled_duelist_value']"
  ];
  ...
  curSetting.skilled_duelist = parseInt2($("input[name='skilled_duelist_value']").val());
...
function LoadSetting(){
  ...
  if(getCookie("existing") !== "1"){
    var defaultSetting = ["existing=1;", "fractalMagicMod=0;", "fractalAttackMod=0;", "additionalMagic=0;", "additionalAttack=0;", "ability_rising=0;", "isBroken=false;", "isWeakness=false;", 
                         ...
                         "trance=trance II;", "overboost_lvl=32;", "curAbility=0;", "cross_counter=0", "skilled_duelist=0"]
  ...
  var inputName = [ "input[name='addition_mag']", "input[name='addition_atk']",
                    ...
                    "input[name='multiply_atk']", "input[name='multiply_mag']", "input[name='simulate_ability_rising']", "input[name='cross_counter_value']", "input[name='skilled_duelist_value']"]
  ...
  var cookieName = ["additionalMagic" ,"additionalAttack", 
                    ...
                    "fractalAttackMod", "fractalMagicMod", "simulate_ability_rising", "cross_counter", "skilled_duelist"]
...
function DisplayResult() {
	...
	for (let i = startIndex; i < (startIndex + endCount); i++) {
        ...
        if (dmgResult.skilled_duelist > 0) {
			resultHTML += "<div class=\"perk-label\">Skilled Duelist +" + numberWithCommas(dmgResult.skilled_duelist) + "%</div>";
		}
...
function resetInput(){
    var inputName = [ "input[name='addition_mag']", "input[name='addition_atk']",
                    ...
                    "input[name='ee_power']", "input[name='ability_chain']", "input[name='attuned_chain']",
                    "input[name='ravage_power']", "input[name='overpower']", "input[name='ability_rising']",
                    "input[name='multiply_atk']", "input[name='multiply_mag']", "input[name='cross_counter_value']", "input[name='skilled_duelist_value']"]
